...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Nós Dois · Listas de presentes de casamento" },
      {
        name: "description",
        content:
          "Plataforma de listas de presentes de casamento com confirmação de presença e pagamento por Pix ou cartão.",
      },
